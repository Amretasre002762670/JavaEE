...
public class MovieController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getParameter("index").equalsIgnoreCase("formsubmission")) {
            if(request.getParameter("selection").equals("add")){
                RequestDispatcher rd = request.getRequestDispatcher("/JSP/addMovies.jsp");
                rd.forward(request, response);
            } else if (request.getParameter("selection").equals("browse")) {
